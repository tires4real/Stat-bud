...
path_to_file<-"C:/Users/�milie/Documents/Pierre/FA Data Exploration"
setwd(path_to_file)

file_name<-"Fatty Acids.xlsx"
sheet_name<-"Paste data on top left"
FA <- read_excel(file_name, sheet = sheet_name, trim_ws=TRUE)
